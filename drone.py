...
#===================================================================
current_longitude = 13.21108
current_latitude = 55.71206
file1 = open('coords.txt', 'w')
file1.write(str(current_longitude) + "\n" + str(current_latitude))
file1.close()
#===================================================================
...
def main():
    ...
    current_longitude = float(file1.readline())
    current_latitude = float(file1.readline())
    file1.close()
    #===================================================================
